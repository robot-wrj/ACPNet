...
parser = argparse.ArgumentParser(description='ACPNet PyTorch Training')
...
parser.add_argument('--scenario', type=str, required=True, choices=["random", "wide", "narrow", "whthin"],
                    help="the dateset scenario")
...
parser.add_argument('--nc', metavar='N', type=int, default=3,
                    help='number class')
parser.add_argument('--scheduler', type=str, default='const', choices=['const', 'cosine'],
                    help='learning rate scheduler')

parser.add_argument('--datatype', type=str, default='CTW2019', choices=['CTW2019', 'KUleuven', 'DeepMIMO'],
                    help='dataset type')
